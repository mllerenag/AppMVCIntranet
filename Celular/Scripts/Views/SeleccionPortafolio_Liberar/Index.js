...
function buscarPortafolios(){
    ...
    var url_ = $("#UrlServicio").val() + '/api/evaluacionbalanceo/BuscarPortafolios';
...
function redirectToEvaluacion(parametro,nombre){
    var entidad_ = { prm : parametro}
    var link = $("#UrlServicioSeleccion").val();
    window.location.href = link + '?prm=' + parametro + "&nom=" + nombre;
}