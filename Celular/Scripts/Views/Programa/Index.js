...
function GrabarDatos(){
    ...
    if (fe_inicio != "" && fe_fin != ""){
        ...
        //var dt_inicio = Date.parse(fe_inicio);//new Date(fe_inicio.substring(6,10),fe_inicio.substring(3,5),fe_inicio.substring(0,2));
        //var dt_fin = Date.parse(fe_fin);//new Date(fe_fin.substring(6,10),fe_fin.substring(3,5),fe_fin.substring(0,2));
